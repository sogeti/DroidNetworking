...
public class DiskCacheTests extends InstrumentationTestCase {
    ...
    @Override
    public void setUp() {
    	NetworkEngine.getInstance().setMemoryCacheSize(0);
    	NetworkEngine.getInstance().setDiskCacheSize(1024);
